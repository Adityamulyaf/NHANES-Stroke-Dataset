...
![Perbandingan AUC-ROC per Skenario](../reports/manual/figures/auc_comparison.png)
...
![Heatmap AUC-ROC Semua Kombinasi](../reports/manual/figures/heatmap_auc.png)
...
![ROC Curve Skenario E](../reports/manual/figures/roc_curve_scenario_E.png)
...
![SHAP Global Feature Importance](../reports/manual/figures/shap_summary_bar.png)
...
#### SHAP Beeswarm Plot
![SHAP Beeswarm Plot](../reports/manual/figures/shap_beeswarm.png)
...
![Kontribusi Kelompok Fitur](../reports/manual/figures/shap_groups.png)
